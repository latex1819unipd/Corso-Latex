...
\usepackage[english, italian]{babel}    % per scrivere in italiano e in inglese;
                                        % l'ultima lingua (l'italiano) risulta quella predefinita
...
\usepackage{enumerate}                  % liste numerate
...
\usepackage[automake, toc, acronym]{glossaries}   % glossario
...
\input{capitoli/capitolo-2}             % Ambiente
\input{capitoli/capitolo-3}             % Analisi
%\input{capitoli/capitolo-4}             % Tecno
%\input{capitoli/capitolo-5}             % Sviluppo
%\input{capitoli/capitolo-6}             % Qualifica
